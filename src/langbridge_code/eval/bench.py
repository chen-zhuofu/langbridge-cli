...
left to config) and the eval/trainer code, which only ever calls a grader
...
# the eval/trainer can be pointed at whatever task set the user picks.
...
# --------------------------------------------------------------------------- #
# Grader factory — the pluggable seam used by the eval/trainer code.           #
# --------------------------------------------------------------------------- #
