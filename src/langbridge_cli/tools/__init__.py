from langbridge_cli.tools import agents, execution, filesystem, plan, skills, testing, web
...
TOOLS = filesystem.TOOLS | testing.TOOLS | execution.TOOLS | agents.TOOLS | plan.TOOLS | web.TOOLS | skills.TOOLS

MAIN_TOOL_NAMES = {"list_dir", "glob", "read_file", "grep", "bash", "read_webpage", "ask_l4_engineer", "ask_l5_engineer", "update_plan"}
